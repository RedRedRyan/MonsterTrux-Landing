        ...
        <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-12 md:p-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:border-white transition">
              ...
              onClick={() => window.open('https://drive.google.com/file/d/1MlttBG7O7vE66TNqeH3u-iDx5pcy-fQH/view?usp=drive_link', '_blank')}
              >
            Download
            </button>
            </div>
          ...
          <p className="text-white/80">Free to play • 150 MB download • Available worldwide</p>
        </div>
      </div>
    </section>
  )
